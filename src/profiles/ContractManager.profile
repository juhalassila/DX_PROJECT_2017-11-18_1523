...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>DELETE_ME__c.DELETE_ME_AGAIN__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <layoutAssignments>
        <layout>Account-Tilin asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Asset-Omaisuuden asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>AssetRelationship-Asset Relationship Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Campaign-Kampanjan asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>CampaignMember-Campaign Member Page Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Tapauksen asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>CaseClose-Sulje tapaus -asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Contact-Yhteyshenkilön asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Contract-Sopimuksen asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Event-Tapahtuman asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Global-Global Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Idea-Idean asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Lead-Liidin asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Opportunity-Mahdollisuuden asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>OpportunityLineItem-Mahdollisuuden tuotteen asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Order-Tilauksen asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>OrderItem-Tilaustuotteen asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Product2-Tuotteen asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Solution-Ratkaisun asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Task-Tehtävän asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>User-Käyttäjän asettelu</layout>
    </layoutAssignments>
    <layoutAssignments>
